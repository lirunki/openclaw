...
export function resolveOpenClawPluginToolsForOptions(params: {
  ...
  if (params.currentTurnDelivery?.toolRef) {
    delete params.currentTurnDelivery.toolRef.value;
  }
  ...
  const currentTurnDelivery = createCurrentTurnDelivery({
    authority: params.currentTurnDelivery?.authority,
  ...
  const currentTurnDeliveryTool =
    params.currentTurnDelivery?.toolRef && currentTurnDelivery
      ? createCurrentTurnDeliveryTool(currentTurnDelivery)
      : undefined;
  if (currentTurnDeliveryTool && params.currentTurnDelivery?.toolRef) {
    params.currentTurnDelivery.toolRef.value = currentTurnDeliveryTool;
  }
