...
export function createEmbeddedAttemptCodingTools(
  ...
  const currentTurnDeliveryToolRef = currentTurnDelivery?.toolRef;
  ...
  rebindCurrentTurnDeliveryToolRef(currentTurnDeliveryToolRef, authorizedTools, finalizedTools);
